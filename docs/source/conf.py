...
# boston_house_prices_kedro documentation build
...
from boston_house_prices_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "boston_house_prices_kedro"
author = "Kedro"
...
htmlhelp_basename = "boston_house_prices_kedrodoc"
...
latex_documents = [
    (
        master_doc,
        "boston_house_prices_kedro.tex",
        "boston_house_prices_kedro Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "boston_house_prices_kedro",
        "Project boston_house_prices_kedro codebase.",
        "Data-Science",
    )
]
